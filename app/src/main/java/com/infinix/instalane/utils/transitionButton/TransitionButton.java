package com.infinix.instalane.utils.transitionButton;
...
public class TransitionButton extends MaterialButton {

    private final int WIDTH_ANIMATION_DURATION = 200; // 200
    private final int SCALE_ANIMATION_DURATION = 600; // 300
    private final int SHAKE_ANIMATION_DURATION = 750; // 500
    private final int COLOR_ANIMATION_DURATION = 350; // 350
    ...
    private void showBackground(Boolean show) {
        ...
        if (show)
            ...
            background = ContextCompat.getDrawable(context, R.drawable.transition_button_progress);
    ...
    private void drawIndeterminateProgress(Canvas canvas) {
        if (progressCircularAnimatedDrawable == null || !progressCircularAnimatedDrawable.isRunning()) {
            ...
            progressCircularAnimatedDrawable = new CircularAnimatedDrawable(context, loaderColor, arcWidth);
    ...
    public void stopAnimation(StopAnimationStyle stopAnimationStyle, final OnAnimationStopEndListener onAnimationStopEndListener) {
        ...
        switch (stopAnimationStyle) {
            ...
            case EXPAND:
                ...
                Drawable background = ContextCompat.getDrawable(context, R.drawable.transition_button_progress);
                setBackground(background);
